...
public class RemoveCompatibilityControllerTest {
    ...
    private RemoveCompatibilityController controller = new RemoveCompatibilityController(partsRepository,
            compatibilitiesRepository);

    @Test
    public void should_remove_compatibility_if_parts_present() {
        // setup
        ...
        verify(compatibilitiesRepository).removeCompatibility(1, 2);
    }

    @Test
    public void should_not_remove_compatibility_if_one_part_missing() {
        // setup
        Part part1 = Part.builder().id(1).name("name").build();
